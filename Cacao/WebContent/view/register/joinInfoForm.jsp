...
<!-- #### 전체 div 시작 -->	
	<div>
		<header style="margin-top: 2%">
			...
			<div>
				<font
					...
					계정만들기</font><img src="../../img/login/loginheader.png"
		...
		<div style="margin-top: -2%;">
			<img alt="" src="../../img/register/agreeBtnImg2.png"
				style="margin-left: 10%; height: 60px; margin-top: -0.24%;"> <img
				alt="" src="../../img/register/agreeInput2.png"
				style="margin-left: -1%; height: 60px;""> <img alt=""
				src="../../img/register/agreeInput3.png"
				style="margin-left: -1%; height: 60px;"">
...
<!-- 					FORM 시작 -->	
				<form class="form-horizontal"
					...
					<div class="form-group" style="margin-left: 7%;">
						...
						<small style="margin-left: 29%">· 꼭 실제로 사용중인 이메일주소를
							입력해주세요. </small><br> <small style="margin-left: 29%">· 비밀번호
					...
					<div class="form-group" style="margin-left: 7%;">
						...
						<small style="margin-left: 29%">· 비밀번호는 8~16자의 영문 대소문자,
							숫자, 특수문자를 조합하여 설정해주세요.</small><br> <small style="margin-left: 29%">·
							다른사이트에서 사용하는 것과 동일하거나 쉬운 비밀번호는 사용하지 마세요. </small><br> <small
							style="margin-left: 29%">· 안전한 계정 사용을 위해 비밀번호는 주기적으로
							변경해주세요.</small>
